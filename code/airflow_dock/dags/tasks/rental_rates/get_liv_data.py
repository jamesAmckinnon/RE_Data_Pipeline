...
output_bucket = Path("/opt/airflow/data/separated_rental_rates")
...
def get_liv_data():
    ...
    print(f"Saving {len(rent_data)} units to liv_rental_rates.json")
    with open(output_bucket / "liv_rental_rates.json", "w") as f:
        f.write(json.dumps(rent_data, indent=4)) 
